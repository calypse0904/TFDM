...
class SuperResModel(UNetModel):
    ...
    def __init__(self, image_size, in_channels,condition_channels, *args, **kwargs):
        super().__init__(image_size, in_channels+condition_channels, *args, **kwargs)
